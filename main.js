...
function createWindow () {
  ...
  mainWindow.loadURL(path.join('file://', __dirname, '/app/resources/index.html'))
  ...
  browserMenu.loadURL(path.join('file://', __dirname, '/app/resources/menu/index.html'))
...
app.on('ready', function () {
  protocol.registerFileProtocol(protocolName, (request, callback) => {
    ...
    callback({
      path: path.normalize(path.join(__dirname, '/../renderer/public/', url))
    })
  }, (error) => {
    if (error) {
